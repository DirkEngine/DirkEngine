...
pub(crate) fn load<T>(value: &crate::LoadOp<T>) -> MTLLoadAction {
    match value {
        crate::LoadOp::Load => MTLLoadAction::Load,
        crate::LoadOp::Clear(_) => MTLLoadAction::Clear,
        crate::LoadOp::DontCare => MTLLoadAction::DontCare,
    }
}
...
pub(crate) fn index(value: crate::IndexFormat) -> MTLIndexType {
    match value {
        crate::IndexFormat::Uint16 => MTLIndexType::UInt16,
        crate::IndexFormat::Uint32 => MTLIndexType::UInt32,
    }
}
