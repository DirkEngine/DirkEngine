...
pub unsafe trait NativeBuffer: Send + Sync + 'static {
...
pub struct ImageViewDesc<'a, B: Api = crate::Rhi> {
    /// Debug label.
    pub label: &'a str,
    /// Image being viewed.
    pub image: &'a B::Image,
...
pub enum BindingResource<'a, B: Api = crate::Rhi> {
...
pub struct BindGroupEntry<'a, B: Api = crate::Rhi> {
...
pub struct BindGroupDesc<'a, B: Api = crate::Rhi> {
    /// Debug label.
    pub label: &'a str,
...
pub struct PipelineLayoutDesc<'a, B: Api = crate::Rhi> {
    /// Debug label.
    pub label: &'a str,
...
pub struct GraphicsPipelineDesc<'a, B: Api = crate::Rhi> {
    /// Debug label.
    pub label: &'a str,
