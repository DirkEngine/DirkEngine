...
impl ImageSubresourceRange {
    #[must_use]
    /// Whether the mip spans overlap, independently of aspects and array layers.
    pub fn overlaps_mips(self, other: Self) -> bool {
        let (this, that) = (self.mip_span(), other.mip_span());
        this.start < that.end && that.start < this.end
    }

    #[must_use]
    /// Returns the base mip and count of the intersecting mip span.
    pub fn mip_intersect(self, other: Self) -> (u32, u32) {
        let (this, that) = (self.mip_span(), other.mip_span());
    ...
    #[must_use]
    pub fn mip_difference(self, minus: Self) -> [(u32, u32); 2] {
    ...
    #[must_use]
    /// Replaces the mip span while preserving aspects and array layers.
    pub fn with_mips(self, base_mip_level: u32, mip_level_count: u32) -> Self {
        Self {
            base_mip_level,
            mip_level_count,
            ..self
